...
def main():
    ...
    open('./output/list_interp.txt', 'w', encoding='utf-8').write('\n'.join(flat_list_interp))
    print('Done - interp: '+str(len(flat_list_interp)))
    open('./output/list_join.txt', 'w', encoding='utf-8').write('\n'.join(flat_list_join))
    print('Done - join: '+str(len(flat_list_join)))
    open('./output/list_rs.txt', 'w', encoding='utf-8').write('\n'.join(flat_list_rs))
